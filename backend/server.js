...
const startServer = async () => {
    ...
    app.listen(PORT, '0.0.0.0', () => {
        ...
        console.log('  DELETE /api/admin/jobs/:id   - Delete job');
        console.log('  GET  /api/admin/applications - Get all applications');
        console.log('  PUT  /api/admin/applications/:id/status - Update application status');
        console.log('  GET  /api/admin/admins       - Get all admins');
